...
export default function Comments({ postId }: CommentsProps) {
  ...
  const renderComment = (comment: Comment, depth: number = 0) => (
    <div key={comment.id} className={`${depth > 0 ? 'ml-8 mt-6' : 'mt-6'} ${depth === 0 ? 'border-b border-slate-200 dark:border-slate-700 pb-8' : ''}`}>
      <div className="flex items-start space-x-3">
        {/* 작은 아바타 */}
        <div className="flex-shrink-0">
          <div className="w-6 h-6 bg-gradient-to-br from-sky-500 to-gray-500 rounded-full flex items-center justify-center text-white font-medium text-xs">
    ...
    <div className="mt-8 border-t border-slate-200 dark:border-slate-700 pt-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          <div className="w-6 h-6 bg-gradient-to-r from-sky-500 to-gray-500 rounded-md flex items-center justify-center">
        ...
        <button
          ...
          className="inline-flex items-center space-x-1 px-4 py-2 bg-gradient-to-r from-sky-500 to-gray-600 text-white text-sm rounded-lg hover:from-sky-600 hover:to-gray-700 focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 transition-all duration-200 shadow-sm"
        >
