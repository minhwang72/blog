    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 p-6 rounded-lg border border-purple-100 dark:border-purple-800/50">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-center">
              <span className="mr-2">☁️</span>
              DevOps & Tools
            </h3>
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-8">
          <a 
            ...
            className="flex items-center justify-center space-x-3 bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white p-4 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            ...
            <div className="text-left">
              ...
              <div className="text-sm opacity-90">zxcyui6181@naver.com</div>
            </div>
          </a>
          ...
          <a 
            ...
            className="flex items-center justify-center space-x-3 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-900 hover:to-black text-white p-4 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="text-left">
              ...
              <div className="text-sm opacity-90">@minhwang72</div>
            </div>
          </a>
        </div>
