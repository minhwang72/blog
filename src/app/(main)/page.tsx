          ...
          <section className="text-center space-y-12 py-16">
            <div className="space-y-8">
              <div className="relative">
                <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent leading-tight tracking-tight">
                  개발자의 기록 공간
                </h1>
                <div className="absolute -inset-x-8 -inset-y-4 bg-gradient-to-r from-emerald-100/50 via-teal-100/50 to-cyan-100/50 dark:from-emerald-900/20 dark:via-teal-900/20 dark:to-cyan-900/20 rounded-3xl blur-3xl -z-10 opacity-40"></div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-800 p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-emerald-300 dark:hover:border-emerald-600">
                <div className="text-4xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">{posts.length}</div>
                <div className="text-sm font-medium text-slate-600 dark:text-slate-300">총 포스트</div>
                <div className="absolute top-4 right-4 text-emerald-200 dark:text-emerald-800 group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-800 p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-teal-300 dark:hover:border-teal-600">
                ...
                <div className="absolute top-4 right-4 text-teal-200 dark:text-teal-800 group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-800 p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-cyan-300 dark:hover:border-cyan-600">
                ...
                <div className="absolute top-4 right-4 text-cyan-200 dark:text-cyan-800 group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
